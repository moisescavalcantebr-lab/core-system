...
$championshipMode = !empty($championshipMode);
...
<form action="<?= htmlspecialchars($formAction) ?>" method="POST" class="c-card">
    ...
    <div class="c-form-grid">
        ...
        <?php if ($championshipMode): ?>
            <input type="hidden" name="context" value="external">
            <input type="hidden" name="type" value="championship">
            <input type="hidden" name="status" value="active">
        <?php elseif ($hasInternalOption): ?>
            <div class="c-form-group">
    ...
    <?php if ($championshipMode): ?>
        <div class="c-competition-context-note">
            O campeonato usa o Meu Time como base da escalação e permite manter uma agenda separada do Amistoso.
        </div>
    <?php else: ?>
