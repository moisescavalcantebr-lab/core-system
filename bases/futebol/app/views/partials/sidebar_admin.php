...
function sidebarIcon(string $key): string
{
    $icons = [
        ...
        'treino' => '<path d="M4 6h16v12H4z"/><path d="M12 6v12"/><circle cx="8" cy="12" r="1.5"/><circle cx="16" cy="12" r="1.5"/>',
        'partidas' => '<rect x="4" y="5" width="16" height="14" rx="2"/><path d="M8 3v4"/><path d="M16 3v4"/><path d="M4 10h16"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M16 14h.01"/>',
        'player_financeiro' => '<path d="M12 3v18"/><path d="M17 7.5c-.8-1-2.2-1.5-4-1.5-2.2 0-4 1-4 2.7 0 1.8 1.8 2.4 4 2.8 2.4.5 4 1.1 4 2.9 0 1.7-1.8 2.6-4 2.6-2 0-3.6-.6-4.6-1.8"/>',
...
<nav class="c-sidebar-nav">
    ...
    <?php if (in_array($role, ['PLAYER', 'FINANCE'], true)): ?>
        <div class="c-sidebar-section">

            <div class="c-sidebar-title">Jogador</div>

            <?php if (is_file(PROJECT_PATH . '/web/admin/player/financeiro.php')): ?>
                <a href="<?= PROJECT_URL ?>/admin/player/financeiro.php"
                   class="c-sidebar-link <?= sidebarIsActive('/admin/player/financeiro') ?>">
                    <?= sidebarIcon('player_financeiro') ?>
                    Meu Financeiro
                </a>
            <?php endif; ?>
